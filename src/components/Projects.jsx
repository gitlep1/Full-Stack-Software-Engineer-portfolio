  ...
  return (
    <div className="-mt-[6rem]">
      ...
      <div className="w-full flex">
        ...
        >
          These projects highlight my expertise through real-world applications,
          featuring brief descriptions, live demos, and code repositories. They
          showcase my problem-solving skills, adaptability to different
          technologies, and ability to manage complex projects efficiently.
        </motion.p>
      </div>
